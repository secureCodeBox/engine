...
public class NcrackProcessTest {
    ...
    public void init() {
         ...
         */
        autoMock("bpmn/ncrack_process.bpmn");
        ...
        when(process.waitsAtServiceTask(DO_SCAN_TASK_ID)).thenReturn(task -> startExternalMockProcess("ncrack_brute_force_scan"));
    }
